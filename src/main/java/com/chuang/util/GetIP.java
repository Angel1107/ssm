...
public final class GetIP {
     ...
     */  
    private static Logger logger = Logger.getLogger(GetIP.class);  
    ...
    public static String getBrowserName(String agent) {  
      ...
      public static String getOSName(String agent,HttpServletRequest request){
    	  if(isMobileDevice(request)){
    		  return "Mobile";
    	  }else if(agent.indexOf("Linux")>0 &&!isMobileDevice(request)){
    		  return "Linux";
    	  }else {
			return "Windows";
		}
    ...
    public static void main(String[] args) {  
        List<String> ipList = GetIP.getLocalIPList();  
