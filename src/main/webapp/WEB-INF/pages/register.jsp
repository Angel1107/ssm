...
<!-- 	<script src="http://apps.bdimg.com/libs/jquery/2.1.4/jquery.min.js"></script> -->
  ...
  <body style="background-image: url(../css/images/bg.jpg);background-size: cover;" align="center">
<%--   <form action="<%=basePath%>user/register.do" method="post" align="center" enctype="multipart/form-data"><br><br> --%>
    	...
    	用户密码: <input type = "text" id="password" name="password" required="required" placeholder="请输入你的密码"><br><br>
    	电话号码: <input name="phone" id = "phone" pattern="(\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$" required="required" type="text" placeholder="请输入11位电话号码"><br><br>
    	电子邮箱: <input type="email" id = "email" placeholder="请输入你的的邮箱"><br><br>
    	上传头像
    	<div id="img">
		...
		<br>
		  <div class="center">
 		<input id = "image" type="image" src="../css/images/zc.png"  alt="注册" width="105px">
 	 	  </div>

	<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form class="avatar-form" action="<%=basePath%>user/upimg" id = "uploadForm" enctype="multipart/form-data" method="post">
				<div class="modal-header">
					<button id="close" class="close" data-dismiss="modal" type="button">&times;</button>
				...
				<div class="modal-body">
					<div class="avatar-body">
						<div class="avatar-upload">
							...
							<input class="avatar-input" id="avatarInput" id = "upfile" name="file" type="file"></div>
						<div class="row">
							<div class="col-md-9">
						...
						<div class="row avatar-btns">
							...
							<div class="col-md-3">
								<button class="btn btn-success btn-block avatar-save" type="button" id="upsubmit"><i class="fa fa-save"></i> 保存修改</button>
							</div>
						</div>
					</div>
				</div>
